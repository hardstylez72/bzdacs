...
func (m *RouteFilter) validateNamespaceID(formats strfmt.Registry) error {
...
func (m *RouteFilter) validatePage(formats strfmt.Registry) error {
...
func (m *RouteFilter) validatePageSize(formats strfmt.Registry) error {
