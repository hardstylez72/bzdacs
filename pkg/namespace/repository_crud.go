...
func UpdateConn(ctx context.Context, conn *sqlx.DB, namespace *Namespace) (*Namespace, error) {
	query := `
	update tags 
	   set name = :name,
		   updated_at = now()
...
func  InsertConn(ctx context.Context, conn *sqlx.DB, namespace *Namespace) (*Namespace, error) {
	query := `
...
func GetByIdConn(ctx context.Context, conn *sqlx.DB, id int) (*Namespace, error) {
	query := `
		select id,
			   name,
			   created_at,
