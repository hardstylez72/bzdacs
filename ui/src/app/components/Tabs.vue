...
import RouteTable from '@/route/pages/Routes.vue';
import TapGroupTable from '@/group/pages/Groups.vue';
import TapUserTable from '@/user/pages/Users.vue';
import TabTagsTable from '@/tag/pages/Tags.vue';
