...
// UserRoutePair user route pair
//
// swagger:model userRoutePair
...
// Validate validates this user route pair
...
// ContextValidate validates this user route pair based on context it is used
