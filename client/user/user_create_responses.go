...
func (o *UserCreateOK) Error() string {
	return fmt.Sprintf("[POST /v1/user/create][%d] userCreateOK  %+v", 200, o.Payload)
}
func (o *UserCreateOK) GetPayload() *models.UserGetResponse {
	return o.Payload
}
...
func (o *UserCreateBadRequest) Error() string {
	return fmt.Sprintf("[POST /v1/user/create][%d] userCreateBadRequest  %+v", 400, o.Payload)
}
func (o *UserCreateBadRequest) GetPayload() *models.UtilResponseWithError {
	return o.Payload
}
...
func (o *UserCreateInternalServerError) Error() string {
	return fmt.Sprintf("[POST /v1/user/create][%d] userCreateInternalServerError  %+v", 500, o.Payload)
}
func (o *UserCreateInternalServerError) GetPayload() *models.UtilResponseWithError {
	return o.Payload
}
